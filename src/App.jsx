...
const INITIAL_ITEMS = [
  ...
  { name: "Kits de parafusos c/ arruelas", status: "operacional", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Escritório", "", 2)] },
  { name: "Kits união horizontal", status: "operacional", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Escritório", "", 2)] },
  ...
  { name: "Bolsa de cintura", status: "operacional", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Escritório", "", 1)] },
  ...
  { name: "Módulos RFID padrão menor", status: "defeito parcial", min_stock: 2, qty_in_use: 0, qty_defect: 1, responsavel: "", rfid_tag: "", locations: [mk("Escritório", "", 3)] },
  ...
  { name: "Filtro de linha", status: "operacional", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Armário", "", 1)] },
  ...
  { name: "Celulares", status: "verificar", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Armário", "", 2), mk("Central de Reparos", "Bancada de testes", 1)] },
  ...
  { name: "Caixa Steck", status: "operacional", min_stock: 1, qty_in_use: 0, qty_defect: 0, responsavel: "", rfid_tag: "", locations: [mk("Armário", "", 1)] },
